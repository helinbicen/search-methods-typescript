class PuzzleState {
  ...
  function dlsSearch(currentState: PuzzleState, goalState: PuzzleState, depthLimit: number): PuzzleState | null {
    if (depthLimit === 0) {
